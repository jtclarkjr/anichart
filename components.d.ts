...
declare module 'vue' {
  export interface GlobalComponents {
    AnimeBanner: typeof import('./src/components/anime/AnimeBanner.vue')['default']
    AnimeCard: typeof import('./src/components/anime/AnimeCard.vue')['default']
    AnimeDescription: typeof import('./src/components/anime/AnimeDescription.vue')['default']
...
// For TSX support
declare global {
  const AnimeBanner: typeof import('./src/components/anime/AnimeBanner.vue')['default']
  const AnimeCard: typeof import('./src/components/anime/AnimeCard.vue')['default']
  const AnimeDescription: typeof import('./src/components/anime/AnimeDescription.vue')['default']
